    ...
    render() {
        ...
        return (
            <Col xs="16" sm="8" md="6" className={'mt-2 cardDiv'}>
                <Card id={`catCard${details.id}`} className={'card-accent-primary mb-0'} style={{border: `2px outset ${color}`}} >
                    <CardHeader className="d-flex no-wrap justify-content-center flex-lg-row card"
                        ...
                        <h4 className="categoryHeader">{details.category_name} </h4>
                            <div className="card-header-actions">
                                <Badge pill style={{backgroundColor: color}} className="float-right"> {countPages} </Badge>
                            </div>
                        </div>
