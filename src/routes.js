...
const HomeTabs      = React.lazy(() => import('./views/Pages/KnowledgeBase/HomeTabs'));
...
const routes = [
    ...
    { path: '/dashboard/editor/new', exact: true, name: 'New', component: New },
    { path: '/dashboard/editor/edit', exact: true, name: 'EditList', component: EditList },
    { path: '/dashboard/editor/edit/:search', name: 'Edit', component: Edit },
    { path: '/dashboard/editor/delete', exact: true, name: 'DeleteList' , component: DeleteList },
    { path: '/dashboard/editor/delete/:search', name: 'Delete', component: Delete },
    { path: '/dashboard/images/upload', name: 'UploadImage', component: UploadImage },
    { path: '/dashboard/images/gallery', name: 'Gallery', component: Gallery },
    { path: '/categorycard', name: 'CategoryCard', component: CategoryCard },
    { path: '/hometabs', name: 'HomeTabs', component: HomeTabs },
